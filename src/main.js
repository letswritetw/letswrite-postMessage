...
function receiveMessage(e) {
  ...
  if(e.origin !== 'https://letswritetw.github.io') {
    alert('資料來源錯誤');
    return false;
  }
  // 來源網址是指定的網域時
...
document.getElementById('blue').addEventListener('click', () => {
  iframe.postMessage('lightskyblue', 'https://letswritetw.github.io');
});
document.getElementById('gold').addEventListener('click', () => {
  iframe.postMessage('gold', 'https://letswritetw.github.io');
});
document.getElementById('green').addEventListener('click', () => {
  iframe.postMessage('lightgreen', 'https://letswritetw.github.io');
});